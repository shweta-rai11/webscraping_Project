...
save_accessions_to_sheet(geo_accessions, dir, filename="geo_accessions_oncogene.xlsx")

input_geo = os.path.join(dir, "geo_accessions_oncogene.xlsx")
...
metadata_file = os.path.join(dir, "geo_pubmed_metadata_oncogene.xlsx")
pd.DataFrame(geo_metadata).to_excel(metadata_file, index=False)

cleaned_file_data = os.path.join(dir, "cleaned_geo_pubmed_metadata_oncogene.xlsx")
clean_pubmed_ids(metadata_file, cleaned_file_data)
nct_output_file = os.path.join(dir, "output_excel_file_oncogene.xlsx")
process_pubmed_ids(cleaned_file_data, nct_output_file)
final_output_file = os.path.join(dir, "output_with_valid_nct_oncogene.xlsx")
